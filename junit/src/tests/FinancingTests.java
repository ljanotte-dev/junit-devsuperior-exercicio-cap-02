...
public class FinancingTests {
	...
	@Test
	public void constructShouldCreateObjectWhenValidDate() {
	...
	@Test
	public void constructShouldThrowIllegalArgumentExceptionWhenInvalidDate() {
	...
	@Test
	public void setTotalAmountShouldWhenValidDate() {
		Financing f = new Financing(100000.0, 2000.0, 80);
	...
	@Test
	public void setIncomeShouldWhenValidDate() {
		Financing f = new Financing(100000.0, 2000.0, 80);
		f.setIncome(2100.0);
	...
	@Test
	public void setMonthsShouldWhenValidDate() {
		Financing f = new Financing(100000.0, 2000.0, 80);
		f.setMonths(81);
	...
	@Test
	public void setMounthsShouldThrowIllegalArgumentExceptionWhenInvalidDate() {
		Assertions.assertThrows(IllegalArgumentException.class, () -> {
			Financing f = new Financing(100000.0, 2000.0, 80);
			f.setMonths(79);
		});
